import random
import hangman
def choose_secret_word(wordss: list[str]) -> str:
    num_random = random.randint(0,len(wordss)-1)
    return wordss[num_random]

def this_word():
    wordss = ["בננה", "תפוח", "חציל", "עגבניה", "מלפפון", "מחשב", "עכבר", "מקלדת", "מסך", "טלפון"
